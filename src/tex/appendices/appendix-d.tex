...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/static/detection_timeline.png}
    \caption{Synthetic media arms race: generation advances versus detection methods (2017--2026). Detection consistently lags generation by 6--12 months. As generators approach photorealism, detection becomes theoretically impossible without cryptographic provenance.}
