...
\textbf{The critical insight: only three enforcement types exist.} While information and decision mechanisms have many implementations, enforcement has only three logically possible types.
...
Human enforcers have enforcement capability and access to extraction opportunities. From bounded rationality (see Assumption~\ref{assum:bounded-rationality} (Appendix~\ref{app:b})), some enforcers at some times will extract utility when the benefit exceeds the expected cost of detection.
...
\emph{Mathematical formulation:} Theorems~\ref{thm:cooperation} and~\ref{thm:resolution} establish conditions under which voluntary coordination is stable.
...
\textbf{The observer regress problem.}
...
\textbf{The information asymmetry problem.}
...
\textbf{The computational complexity barrier.}
...
\textbf{The voluntary cooperation stability condition.}
...
\textbf{Why game theory points to binary choice.}
