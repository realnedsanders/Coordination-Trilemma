...
\textbf{What this appendix is.}

\textbf{Purpose:} Analysis of practical challenges facing voluntary coordination, with honest uncertainty quantification.

\textbf{What this is NOT:} Proof that VCS will work. (We only prove it's necessary; see Appendix~\ref{app:b}.)
...
\textbf{Decision theory under deep uncertainty.}
...
\textbf{Framing uncertainty correctly.}
...
\textbf{Why traditional solutions recreate the problem.}

\textbf{Enforcement authority} $\to$ Requires enforcers $\to$ Who watches them? $\to$ Returns to corruption (Theorem~\ref{thm:trilemma})
...
\textbf{The voluntary coordination approach.}
...
If cost of defection exceeds benefit, cooperation becomes Nash equilibrium (Theorem~\ref{thm:cooperation}). This requires:
...
\textbf{The psychopath problem specifically.}
...
\textbf{Why attempt anyway:} (Decision theory from3)
...
Not attempting means certain doom via default trajectory (Theorem~\ref{thm:terminus}).


\subsection{External Military Threats}

\textbf{The historical pattern.}
...
\textbf{The voluntary coordination alternative.}
...
\textbf{Historical examples that worked.}
...
\textbf{Why distributed defense can work.}
...
\textbf{Minimum viable community.}
...
\textbf{Modern and near-scale examples.}
...
\textbf{Scaling beyond initial communities.}
...
\textbf{Why these uncertainties don't change the decision.}
